...
print(
    f"Primary model (lm4) history length before context switch: {len(lm4.history)}")
...
print(
    f"Secondary model now has {len(lm3.history)} interaction(s) in its history.")
